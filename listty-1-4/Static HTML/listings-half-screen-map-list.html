...
<head>
  ...
  <![endif]-->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCUuEI5R2OBqsu1qj2iv2CnbznI0N-X6M4&libraries=places"></script>
        	...
        	<form>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                  <div class="form-group">
                    <div class="input-group">
                      <div class="input-group-addon" for="locationTextField"> Proche </div>
                      <input type="text" class="form-control" id="locationTextField" placeholder="Type Location">
                      <div class="input-group-addon addon-right"><i class="icon-listy icon-target" aria-hidden="true"></i>
						</div>
        			...
        			<div class="col-xs-12">
        				<div class="resultBar barSpaceAdjust">
        					...
        					<ul class="list-inline">
        						<li><a href="listings-half-screen-map-grid.html"><i class="fa fa-th" aria-hidden="true"></i></a></li>
        						<li class="active"><a href="listings-half-screen-map-list.html"><i class="fa fa-th-list" aria-hidden="true"></i></a></li>
        					</ul>
								</div>
								<div id="list-items">
