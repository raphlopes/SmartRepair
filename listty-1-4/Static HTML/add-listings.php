        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-dash">
            <ul class="nav navbar-nav mr0">
              ...
              <li class="dropdown singleDro active">
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="dashboard.html">Dashboard</a></li>
          <li class="active">Submit Listings</li>
        </ol>
      </div>
    </div>
  </div>
				...
				<form action="" method="" class="listing__form">
						...
						<div class="profileIntro paraMargin">
							...
							<div class="row">
								<div class="form-group col-sm-6 col-xs-12">
									...
									<input type="text" class="form-control" id="nomBoutique" placeholder="Nom de votre boutique">
								</div>
								<div class="form-group col-xs-12">
									<label for="discribeTheListing">Description</label>
									<textarea class="form-control" rows="3" placeholder="Description de vos services"></textarea>
								</div>
								<div class="form-group col-xs-12">
                  ...
                  <?php
                      ...
                      <?php
                          ...
                          $subjectName = "SELECT id_nom FROM marque";
                          ...
                          <h2> Dynamic CheckBox </h2>
                           ...
                           echo "<input type='checkbox' value='{$data['id_nom']}'>" . $data['id_nom'] . '</br>';
                          }
					...
					<div class="dashboardBoxBg mb30">
						<div class="profileIntro paraMargin">
							...
							<div class="row">
								...
								<div class="form-group col-sm-6 col-xs-12">
									<label for="listingAddress">Addresse</label>
									...
									<div class="imageUploader text-center">
										<div class="file-upload">
											<div class="upload-area">
												...
												<button class="browse" type="button">Cliquer ou déposer des images</button>
											</div>
										</div>
									</div>
								</div>
