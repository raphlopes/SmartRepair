				...
				<div class="inner-container">
					<div class="map-lg-fixed">
						<div class="map-container">
							<div id="map-canvas" class="map-half"></div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-md-4 col-md-pull-8 col-xs-12 col-lg-6 col-lg-pull-6">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-12 col-xs-12">
								<div class="resultBar">
									<h2>On a trouvé <span>6</span> Résultats pour vous</h2>
									<ul class="list-inline">
										<li class="active"><a href="listings-half-screen-map-grid.html"><i class="fa fa-th" aria-hidden="true"></i></a></li>
										<li><a href="listings-half-screen-map-list.html"><i class="fa fa-th-list" aria-hidden="true"></i></a></li>
									</ul>
								</div>
								...
								$bdd = new PDO('mysql:host=127.0.0.1;dbname=smartrepair', 'root', '');
								 ...
								 foreach($list4 as $value)
      							{
									 $sql5="SELECT * FROM probleme INNER JOIN concordance_probleme_reparateur ON probleme.id_probleme=concordance_probleme_reparateur.id_probleme_ref INNER JOIN modele ON modele.id_modele=probleme.modele_ref WHERE probleme.nom='" .$probleme."' AND modele.nom='" .$modele."'AND id_reparateur_ref= ".$value['id_reparateur'] ;
									...
									<div class="row">
										<div class="col-sm-5 col-xs-12">
											<div class="categoryImage">
												<img src="reparateurs/avatars/<?php echo $value['avatar']; ?>" alt="Image category" class="img-responsive img-rounded">
											</div>
										</div>
