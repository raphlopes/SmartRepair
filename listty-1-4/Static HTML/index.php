...
<title>Page d'Accueil - Smart Repair</title>
...
<section class="clearfix thingsArea">
	<div class="container">
		<div class="page-header text-center">
			<h2>Quelques exemples de réparateurs <small>Voici les réparateurs</small></h2>
		</div>
		<div class="row">
...
<!--
				...
				<div class="thingsBox thinsSpace">
					<div class="thingsImage">
						...
						<div class="thingsMask">
							...
							<a href="listing-details-left.html"><h2>Smart Repair</h2></a>
							<p>24 Boulevard des Italiens, Paris</p>
						</div>
					</div>
					<div class="thingsCaption ">
						<ul class="list-inline captionItem">
				...
				<div class="thingsBox thinsSpace">
					<div class="thingsImage">
						...
						<div class="thingsMask">
							...
							<a href="listing-details-left.html"><h2>Smart Repair<i class="fa fa-check-circle" aria-hidden="true"></i></h2></a>
							<p>10 Rue de la paix, Paris</p>
						</div>
					</div>
					<div class="thingsCaption ">
						<ul class="list-inline captionItem">
							<li><i class="fa fa-heart-o" aria-hidden="true"></i> 9.5 k</li>
							<li><a href="listings-half-screen-map-list.html">Réparations</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="thingsBox thinsSpace">
					<div class="thingsImage">
						...
						<div class="thingsMask">
							...
							<a href="listing-details-left.html"><h2>Smart Repair <i class="fa fa-check-circle" aria-hidden="true"></i></h2></a>
							<p>50 Rue de Turbigo</p>
						</div>
					</div>
					<div class="thingsCaption ">
						<ul class="list-inline captionItem">
							<li><i class="fa fa-heart-o" aria-hidden="true"></i> 596</li>
							<li><a href="listings-half-screen-map-list.html">Réparations</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="thingsBox thinsSpace">
					<div class="thingsImage">
						...
						<div class="thingsMask">
							...
							<a href="listing-details-left.html"><h2>Smart Repair</h2></a>
							<p>128 Avenue de la République, Paris</p>
						</div>
					</div>
					<div class="thingsCaption ">
						<ul class="list-inline captionItem">
				...
				<div class="thingsBox thinsSpace">
					<div class="thingsImage">
						...
						<div class="thingsMask">
							...
							<a href="listing-details-left.html"><h2>Smart Repair <i class="fa fa-check-circle" aria-hidden="true"></i></h2></a>
							<p>8 Rue Pasteur, Paris</p>
						</div>
					</div>
					<div class="thingsCaption ">
						<ul class="list-inline captionItem">
							<li><i class="fa fa-heart-o" aria-hidden="true"></i> 3k</li>
							<li><a href="listings-half-screen-map-list.html">Réparations</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="thingsBox thinsSpace">
					<div class="thingsImage">
						...
						<div class="thingsMask">
							...
							<a href="listing-details-left.html"><h2>Smart Repair</h2></a>
							<p>275 Boulevard Voltaire, Paris</p>
						</div>
					</div>
					<div class="thingsCaption ">
						<ul class="list-inline captionItem">
			...
			<div class="col-xs-12">
				<div class="btnArea btnAreaBorder text-center">
					<a href="listings-half-screen-map-list.html" class="btn btn-primary">Plus de réparateurs</a>
				</div>
			</div>
		--> 
        ...
        <div class="col-xs-12">
          <div class="servicesItem">
            <ul class="list-inline listServices">
              <li>
                <div class="servicesIcon"> <i class="icon-listy icon-key"></i> </div>
                <div class="servicesInfo">
                  <h2>Simple d'Utilisation</h2>
                  <p>SmartRepair permet aux utilisateurs de se renseigner simplement.</p>
                </div>
              </li>
              <li>
                <div class="servicesIcon"> <i class="icon-listy icon-wreath"></i> </div>
                <div class="servicesInfo">
                  <h2>Blabla2</h2>
                  <p>Blabla2</p>
                </div>
              ...
              <li>
                <div class="servicesIcon"> <i class="icon-listy icon-tag3"></i> </div>
                <div class="servicesInfo">
                  <h2>Blabla3</h2>
                  <p>Blabla3</p>
                </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="loginForm">
          ...
          <div class="form-group"> <i class="fa fa-lock" aria-hidden="true"></i>
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox">
              Remember me</label>
            <a href="#" class="pull-right link">Fogot Password?</a> </div>
        </form>
      </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCUuEI5R2OBqsu1qj2iv2CnbznI0N-X6M4&callback=loadMap"></script> 
