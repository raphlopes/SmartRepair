            ...
            <ul class="list-inline listServices">
              ...
              <li>
                ...
                <div class="servicesInfo">
                  ...
                  <p>SmartRepair permet aux utilisateurs de trouver rapidement une soltion</p>
                </div>
              </li>
              <li>
                <div class="servicesIcon"> <i class="icon-listy icon-tag3"></i> </div>
                <div class="servicesInfo">
                  <h2>Réparateurs agréés</h2>
                  <p>SmartRepair vous permet de garder votre garantie</p>
                </div>
              </li>
            </ul>
          </div>
...
<!-- JAVASCRIPTS --> 
<?php include('write_rep_json.php'); ?>
