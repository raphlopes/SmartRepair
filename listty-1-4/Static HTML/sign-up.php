				...
				<div class="signUpFormArea">
                    ...
                    <input type="password" class="form-control" id="mdp2" placeholder="Confirmez votre mdp"  name="mdp2">
						...
						<div class="formSection">
								...
								<div class="row">
									<div class="form-group col-xs-12">
										<label for="usernames" class="control-label">Confirmez que vous êtes un humain*</label>
									...
									<div class="form-group col-xs-12">
										<div class="checkbox">
											<label>
												...
												J'accepte <a href="terms-of-services.html">les Conditions d'utilisations</a>
											</label>
										</div>
									</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <p>Pas de compte ? <a href="#" class="link">Inscription</a></p>
        </div>
      </div>
    </div>
  </div>
